										...
										if (*(float*)((unsigned __int32)Weapon + 1720) <= Global_Variables->Current_Time)
										{
											...
											Traverse_Sorted_Target_List_Label:
											{
												...
												else
												{
													...
													if (Console_Variable_Flow_Synchronization.Integer == 0 ? 1 : (__int32)(Absolute(*(float*)((unsigned __int32)Local_Player + 104) + Choked_Commands_Count * Global_Variables->Interval_Per_Tick - *(float*)((unsigned __int32)Optimal_Target + 104)) / Global_Variables->Interval_Per_Tick + 0.5f) <= Console_Variable_Flow_Synchronization_Tolerance.Integer)
													{
